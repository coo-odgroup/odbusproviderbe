											  ...
											  <table width="100%" cellspacing="0" cellpadding="0" border="0">
												...
												<tr>
												   <td style="padding: 0px 10px; font-size: 13px; font-family: sans-serif; font-weight:400;" align="left">
													<p>Dear {{$userName}},</p>
													<p>Welcome to ODBUS. Your agentID has been creates successfully.</p>
                                                    <p>
                                                        <strong>Login ID :</strong> {{$userEmail}}
                                                        <br>
                                                         <strong>Passoword :</strong> {{$userPassword}}
                                                    </p>
                                                                                   
                                                    <p>
                                                        <a href="{{$loginUrl}}"><strong>CLICK HERE TO LOGIN</strong>
                                                    </p>                                                   
                                                   <p><strong>Thanks for trusting us.</strong><br><strong>-Team ODBUS</strong></p>
