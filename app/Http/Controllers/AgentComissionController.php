...
class AgentComissionController extends Controller
{
    ...
    protected $AgentCommisonRepository;
    
    public function __construct(AgentCommissionService $agentCommissionService,
                                AgentCommissionValidator $agentCommissionValidator,
                                AgentCommissionRepository $AgentCommisonRepository)
    {
        $this->agentCommissionService = $agentCommissionService;
        $this->agentCommissionValidator = $agentCommissionValidator;
        $this->AgentCommisonRepository = $AgentCommisonRepository;
    }
    ...
    // }
     ...
     public function getAllAgentCommissionData(Request $request) {
      ...
      $agentCommissions = $this->AgentCommisonRepository->getAllAgentCommissionData($request);
      return $this->successResponse($agentCommissions,Config::get('constants.RECORD_FETCHED'),Response::HTTP_OK); 
    }
