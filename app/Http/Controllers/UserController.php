  ...
  public function AgentForgetPasswordOtp(Request $request)
  {
    ...
    try {
      ...
      if ($response == 'NOT FOUND') {
        return $this->errorResponse('Mobile No / Email ID does not exist', Response::HTTP_OK);
      } else {
