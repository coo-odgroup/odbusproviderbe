...
class BusStoppageController extends Controller
{
    ...
    public function __construct(BusSeatsRepository $busSeatsRepository,BusLocationSequenceRepository $busLocationSequenceRepository, BusStoppageTimingRepository $busStoppageTimingRepository, BusStoppageService $busStoppageService, 
