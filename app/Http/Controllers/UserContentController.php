...
class UserContentController extends Controller
{
    ...
    public function __construct(UserContentService $userContentService, UserContentValidator $userContentValidator,UserContentRepository $userContentRepository)
    {
