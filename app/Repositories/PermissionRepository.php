...
class PermissionRepository
{
    ...
    {
        return $this->permission->whereNotIn('status', [2])->get();
    }
    ...
    public function getAllPermissionDT($request)
    {
        ...
        // Total records
        $totalRecords = $this->permission->select('count(*) as allcount')->whereNotIn('status', [2])->count();
        $totalRecordswithFilter = $this->permission->select('count(*) as allcount')
        ->whereNotIn('status', [2])
