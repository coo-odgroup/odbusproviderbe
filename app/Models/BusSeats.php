...
class BusSeats extends Model
{
    ...
    protected $fillable = ['bus_id','ticket_price_id','seats_id','operation_date','status','type' ,'category','seat_type','berth_type','source_id','destination_id','seat_number','duration','created_by','reason','other_reason','vendor_id'];
    public function bus()
    {
